...
##### Functions utilized throughout the analysis
...
# LASSO 
    x_vars <- model.matrix(Life.expectancy~. , df1_complete)[,-1]
    y_var <- df1_complete$Life.expectancy
    ...
    library(lars)
    x <- df1_complete%>% select(-'Life.expectancy')
    lars(x, df1_complete$Life.expectancy,type ="lasso")

...
df.models$Adj.R2 <- c(summary(lmMod)$adj.r.squared,summary(complex.model)$adj.r.squared)
df.models$AIC <- c(AIC(lmMod),AIC(complex.model))
df.models$BIC <- c(BIC(lmMod),BIC(complex.model))
df.models$CV <- c(CV(lmMod)[[1]],CV(complex.model)[[1]])
print(df.models)
```
